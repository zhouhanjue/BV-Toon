...
git init
git add .
git commit -m "BV-Toon 1.7.2: one-click MMD toon shading + integrity-check watermark"
git branch -M main
...
**Releases → Draft a new release → tag `v1.7.2`** → paste the contents of
[`RELEASE-1.7.2.md`](RELEASE-1.7.2.en.md) into the description → attach
`dist\BV-Toon-1.7.2.zip` (its top level is `BV-Toon/`, so users can install it directly).
...
| Release notes | `RELEASE-1.7.2.md` | `RELEASE-1.7.2.en.md` | `RELEASE-1.7.2.ja.md` |

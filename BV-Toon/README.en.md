...
* Add-on manual: [`BV-Toon/README.md`](BV-Toon/README.md) ｜ Changelog: [`CHANGELOG.md`](CHANGELOG.md)
* Latest release: [`RELEASE-1.5.0.md`](RELEASE-1.5.0.md) ｜ MMD etiquette: [`MMD-NOTICE.md`](MMD-NOTICE.md)
...
✅ Free to use (including commercial) ｜ ❌ No redistribution ｜ ❌ No publishing modified versions
｜ ✅ Attribution required. Full text in [`LICENSE`](LICENSE).
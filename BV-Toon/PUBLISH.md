...
git init
git add .
git commit -m "BV-Toon 1.7.2：MMD 一键卡渲 + 完整性校验水印"
git branch -M main
...
**Releases → Draft a new release → tag `v1.7.2`** → 说明区粘 [`RELEASE-1.7.2.md`](RELEASE-1.7.2.md)
的内容 → 附件传 `dist\BV-Toon-1.7.2.zip`（顶层就是 `BV-Toon/`，别人能直接「从磁盘安装」）。
...
| 版本说明 | `RELEASE-1.7.2.md` | `RELEASE-1.7.2.en.md` | `RELEASE-1.7.2.ja.md` |

...
git init
git add .
git commit -m "BV-Toon 1.7.2：MMD ワンクリック・トゥーン + 整合性チェックの透かし"
git branch -M main
...
**Releases → Draft a new release → タグ `v1.7.2`** → 説明欄に
[`RELEASE-1.7.2.md`](RELEASE-1.7.2.ja.md) の内容を貼り付け → 添付に
`dist\BV-Toon-1.7.2.zip` をアップロード（最上位が `BV-Toon/` なので、そのまま
「ディスクからインストール」できます）。
...
| リリースノート | `RELEASE-1.7.2.md` | `RELEASE-1.7.2.en.md` | `RELEASE-1.7.2.ja.md` |
